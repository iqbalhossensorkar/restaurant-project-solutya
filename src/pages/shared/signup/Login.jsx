...
import pizza from '../../../assets/slider-images/burger.png'
            ...
            <div className='container mx-auto text-center'>
                <div className="hero h-56" style={{
                    ...
                    <div className="hero-content">
                        <div className="">
                            <h1 className='text-white text-5xl font-black font-roboto'>Login</h1>
                        </div>
                    </div>
                </div>
                                ...
                                <div>
                                    <div className="hero h-auto" style={{
                                        ...
                                        <div className="hero-content">
                                            ...
                                            <p className='font-normal text-center text-xs mt-5'>Dont Have An Acoount? <Link to='/signup'><span className='text-orange-500'>Sign Up</span></Link></p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
